...
//> inherit-self
        if (stmt.superclass != null &&
            ...
            StormScript.error(stmt.superclass.name,
...
//> return-from-top
        if (currentFunction == FunctionType.NONE) {
            StormScript.error(stmt.keyword, "Can't return from top-level code.");
        }
...
//> Classes return-in-initializer
            if (currentFunction == FunctionType.INITIALIZER) {
                StormScript.error(stmt.keyword,
...
//> invalid-super
        if (currentClass == ClassType.NONE) {
            StormScript.error(expr.keyword,
