...
class StormScriptFunction implements StormScriptCallable {
...
//> Classes is-initializer-field
    ...
    StormScriptFunction(Stmt.Function declaration, Environment closure,
...
//< closure-constructor
    ...
    StormScriptFunction bind(StormScriptInstance instance) {
...
//> lox-function-bind-with-initializer
        return new StormScriptFunction(declaration, environment,
                isInitializer);
//< lox-function-bind-with-initializer
    }
    //< Classes bind-instance
